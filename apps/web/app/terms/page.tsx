...
export const metadata: Metadata = {
  ...
  description: "The rules of using Vendly as a buyer or a seller.",
};
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      description="By using Vendly you agree to these terms. Please read them carefully — they explain your rights and the rules that keep the marketplace fair for everyone."
      updatedAt="May 2026"
      sections={[
        {
          title: "Using Vendly",
          body: (
            <>
              <p>
                You must be at least 16 years old to use Vendly. Sellers must be enrolled
              ...
              <p>
                Don't impersonate anyone, scrape Vendly at scale, or attempt to disrupt the
                service.
              </p>
            </>
          ),
        ...
        {
          title: "Buying on Vendly",
          body: (
            <p>
              Orders form a contract between you and the seller. Vendly facilitates the
        ...
        },
        {
          ...
          body: (
            <>
              ...
              <p>
                Vendly takes a platform fee on each sale; see the Pricing section of your
        ...
        },
        {
          ...
          body: (
            <p>
              ...
              configured by Vendly admins; standard payouts hold for a verification window
        ...
        },
        {
          ...
          body: (
            <p>
              You agree not to use Vendly to: harass other users, list weapons, drugs, or
        ...
        },
        {
          ...
          body: (
            <p>
              Vendly is provided "as is". To the extent permitted by law, our liability for
        ...
        },
        {
          ...
          body: (
            <p>
              ...
              <a className="text-primary underline" href="mailto:legal@vendly.com">
                legal@vendly.com
              </a>{" "}
