...
export const metadata: Metadata = {
  title: "Returns & Refunds · Vendly",
  description: "How returns, refunds, and disputes work on Vendly.",
};
...
export default function ReturnsPage() {
  return (
    <LegalPage
      ...
      description="If something isn't right, we've got you. Here's how Vendly's buyer protection works, and how to start a return."
      updatedAt="May 2026"
      sections={[
        {
          title: "Eligibility",
        ...
        },
        {
          ...
          body: (
            <ol className="list-decimal pl-5 space-y-1.5">
              ...
              <li>The seller has 48 hours to respond. If unresolved, escalate to Vendly support.</li>
            </ol>
          ),
        },
        {
          ...
          body: (
            <p>
              ...
              handled directly by the seller; Vendly supervises disputes.
            </p>
          ),
        },
        {
          ...
          body: (
            <p>
              If you can't reach an agreement with the seller, Vendly mediates and may
