          ...
          <div className="flex items-center gap-3 pl-1">
            {user ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href="/register" className="px-3.5 h-9 inline-flex items-center bg-background text-primary text-xs rounded-lg shadow-sm hover:opacity-90 active:scale-[0.98] transition-all">
                  Sign up
                </Link>
              </div>
            )}
