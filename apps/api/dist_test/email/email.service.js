...
var EmailService = function () {
    ...
    var EmailService = _classThis = /** @class */ (function () {
        ...
        EmailService_1.prototype.sendVerificationEmail = function (to, token) {
            return __awaiter(this, void 0, void 0, function () {
                var url, response, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "".concat(this.configService.get('FRONTEND_URL'), "/verify-email?token=").concat(token);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.resend.emails.send({
                                    ...
                                    html: "<p>Click <a href=\"".concat(url, "\">here</a> to verify your email.</p>"),
                                })];
                        case 2:
                            response = _a.sent();
        ...
        EmailService_1.prototype.sendPasswordResetEmail = function (to, token) {
            return __awaiter(this, void 0, void 0, function () {
                var url, response, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "".concat(this.configService.get('FRONTEND_URL'), "/reset-password?token=").concat(token);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.resend.emails.send({
                                    ...
                                    html: "<p>Click <a href=\"".concat(url, "\">here</a> to reset your password. This link expires in 1 hour.</p>"),
                                })];
                        case 2:
                            response = _a.sent();
