...
var AuthController = function () {
    ...
    var _getApprovalStatus_decorators;
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.getMe = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.getMe(req.user.id)];
                });
            });
        };
        AuthController_1.prototype.verifyEmail = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.verifyEmail(dto)];
                });
            });
        };
        ...
        AuthController_1.prototype.submitVerification = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.submitVerification(req.user.id, dto)];
                });
            });
        };
        AuthController_1.prototype.getApprovalStatus = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.getApprovalStatus(req.user.id)];
                });
            });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, throttler_1.Throttle)({ default: { limit: 5, ttl: 60 } }), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        ...
        _submitVerification_decorators = [(0, common_1.Post)('submit-verification'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        _getApprovalStatus_decorators = [(0, common_1.Get)('approval-status'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        ...
        _updateProfile_decorators = [(0, common_1.Patch)('profile'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
        ...
        __esDecorate(_classThis, null, _getApprovalStatus_decorators, { kind: "method", name: "getApprovalStatus", static: false, private: false, access: { has: function (obj) { return "getApprovalStatus" in obj; }, get: function (obj) { return obj.getApprovalStatus; } }, metadata: _metadata }, null, _instanceExtraInitializers);
