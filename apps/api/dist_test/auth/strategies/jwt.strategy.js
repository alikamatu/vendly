...
var JwtStrategy = function () {
    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(configService, prisma, authService) {
        ...
        JwtStrategy_1.prototype.validate = function (req, payload) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { id: user.id.toString(), email: user.email, role: user.role }];
                    }
                });
            });
        };
