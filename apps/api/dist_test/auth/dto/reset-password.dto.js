...
var ResetPasswordDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _token_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'Token is required' })];
            _newPassword_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(8, { message: 'New password must be at least 8 characters long' }), (0, class_validator_1.MaxLength)(32, { message: 'New password cannot exceed 32 characters' }), (0, class_validator_1.Matches)(/((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/, {
