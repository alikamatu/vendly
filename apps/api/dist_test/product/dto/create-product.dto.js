...
var CreateProductDto = function () {
    ...
    var _quantity_available_decorators;
    var _quantity_available_initializers = [];
    var _quantity_available_extraInitializers = [];
    ...
    return _a = /** @class */ (function () {
            function CreateProductDto() {
                ...
                this.condition = (__runInitializers(this, _currency_extraInitializers), __runInitializers(this, _condition_initializers, void 0));
                this.quantity_available = (__runInitializers(this, _condition_extraInitializers), __runInitializers(this, _quantity_available_initializers, void 0));
                this.status = (__runInitializers(this, _quantity_available_extraInitializers), __runInitializers(this, _status_initializers, void 0));
                ...
                this.attributes = (__runInitializers(this, _tags_extraInitializers), __runInitializers(this, _attributes_initializers, void 0)); // Will be parsed in service if sent as string
        ...
        (function () {
            ...
            _condition_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _quantity_available_decorators = [(0, class_validator_1.IsNumberString)(), (0, class_validator_1.IsOptional)()];
            _status_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _price_decorators = [(0, class_validator_1.IsNumberString)(), (0, class_validator_1.IsNotEmpty)()];
            _category_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _tags_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ each: true })];
            _attributes_decorators = [(0, class_validator_1.IsOptional)()];
            ...
            __esDecorate(null, null, _quantity_available_decorators, { kind: "field", name: "quantity_available", static: false, private: false, access: { has: function (obj) { return "quantity_available" in obj; }, get: function (obj) { return obj.quantity_available; }, set: function (obj, value) { obj.quantity_available = value; } }, metadata: _metadata }, _quantity_available_initializers, _quantity_available_extraInitializers);
