...
var ProductController = function () {
    ...
    var ProductController = _classThis = /** @class */ (function () {
        ...
        ProductController_1.prototype.createProduct = function (req, dto, files) {
            return __awaiter(this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    return [2 /*return*/, this.productService.createProduct(BigInt(req.user.id), dto, files.images || [], (_a = files.video) === null || _a === void 0 ? void 0 : _a[0])];
                });
            });
        };
        ProductController_1.prototype.getCategories = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.productService.getCategories()];
                });
            });
        };
        ProductController_1.prototype.getProducts = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        ProductController_1.prototype.getProductById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.productService.getProductById(BigInt(id))];
                });
            });
        };
    ...
    (function () {
        ...
        _createProduct_decorators = [(0, common_1.Post)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)('SELLER'), (0, common_1.UseInterceptors)((0, platform_express_1.FileFieldsInterceptor)([
                { name: 'images', maxCount: 3 },
                { name: 'video', maxCount: 1 },
            ]))];
        _getCategories_decorators = [(0, common_1.Get)('categories')];
        _getProducts_decorators = [(0, common_1.Get)()];
        _getProductById_decorators = [(0, common_1.Get)(':id')];
