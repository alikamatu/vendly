...
var CloudinaryService = function () {
    ...
    var CloudinaryService = _classThis = /** @class */ (function () {
        function CloudinaryService_1(configService) {
        ...
        CloudinaryService_1.prototype.uploadImage = function (file_1) {
            return __awaiter(this, arguments, void 0, function (file, folder, options) {
                if (folder === void 0) { folder = 'vendly'; }
                if (options === void 0) { options = {}; }
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            var transformations = { folder: folder };
                            ...
                            var upload = cloudinary_1.v2.uploader.upload_stream(transformations, function (error, result) {
                                if (error) {
        ...
        CloudinaryService_1.prototype.uploadVideo = function (file_1) {
            return __awaiter(this, arguments, void 0, function (file, folder) {
                if (folder === void 0) { folder = 'vendly_videos'; }
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            var upload = cloudinary_1.v2.uploader.upload_stream({
                                ...
                                if (!result)
                                    return reject(new Error('Video upload failed: result is undefined'));
                                resolve(result);
                            });
                            upload.end(file.buffer);
                        })];
