...
children.push(para('This is not the engineering spec, not the legal terms of service, and not a sales deck. Engineering details live in the repo (README and API_REFERENCE). Legal terms live on verndly.market/terms. The sales deck lives in the marketing drive.'));
...
children.push(numbered('Land on verndly.market or a shared store/product link.'));
...
children.push(specTable([
  ['Marketplace', 'https://verndly.market'],
  ['Admin dashboard', 'Durabel — internal access only'],
  ['Status page', 'TBD'],
  ['Support email', 'support@verndly.market'],
  ['Press / partnerships', 'hello@verndly.market'],
]));
...
children.push(specTable([
  ['Line item', 'Cost (USD)'],
  ['Domain (verndly.market, 1 year)', '$48'],
  ['Server / hosting', '$74'],
