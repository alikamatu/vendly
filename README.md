...
- **Admin Dashboard** (`apps/admin`): Next.js management dashboard for platform administrators to operate the system, monitor activities, transactions, and manage users.
